...
module.exports = {
  ...
  |
  */
  //  o mais correto é dizer exatamente as urls que irão acessar
  // origin: ['jacode.com.br', ' rocketseat.com.br'],

  // para teste vamo utilizar o true
  origin: true,
  ...
  |
  */
  //  aqui liberamos quais métodos liberamos o acesso
